...
public class HelloWorldController {
    ...
    public Map<String, Object> getTransactions() {
        ...
        response.put("transactions", java.util.List.of(
            Map.of("id", "TXN001", "from", "Sudarshan", "to", "John", "amount", 1000.00, "type", "transfer", "status", "completed"),
            Map.of("id", "TXN002", "from", "Jane", "to", "Electricity Board", "amount", 2500.00, "type", "bill_payment", "status", "completed"),
            Map.of("id", "TXN003", "from", "John", "to", "Internet Provider", "amount", 1500.00, "type", "bill_payment", "status", "pending")
        ));
